...
<div class="min-h-screen bg-irish-stone-light pb-16">
							...
							{#if selectedUser}
								<div class="bg-opacity-20 mt-2 rounded-lg bg-irish-green p-4 text-sm">
									<div class="font-medium text-white mb-2">
										📋 Accommodation Details for: {selectedUser.firstName} {selectedUser.lastName}
									</div>
	...
	{#if selectedUser}
		<div class="mx-auto max-w-4xl px-4 py-8">
			<div class="rounded-lg bg-white p-6 shadow-lg border-l-4 border-irish-green">
				<h2 class="text-2xl font-bold text-irish-navy mb-4">
					🏨 Accommodation Details for {selectedUser.firstName} {selectedUser.lastName}
				</h2>
				...
				{#if selectedUser.accommodationId && selectedUser.accommodationName}
					<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
						<div class="space-y-4">
							<div>
								<h3 class="font-semibold text-irish-navy mb-2">Hotel Information</h3>
								<div class="space-y-2">
									<div class="flex items-start gap-2">
						...
						<div class="space-y-4">
							<div>
								<h3 class="font-semibold text-irish-navy mb-2">Personal Details</h3>
								<div class="space-y-2">
									{#if selectedUser.accommodationLocation}
										<div class="flex items-start gap-2">
											<span class="font-medium text-gray-600">🚪 Room/Location:</span>
											<span class="text-gray-800 font-medium text-irish-green">{selectedUser.accommodationLocation}</span>
										</div>
									{/if}
				...
				{:else}
					<div class="text-center py-8">
						...
						<h3 class="text-xl font-semibold text-gray-600 mb-2">No Accommodation Booked</h3>
						<p class="text-gray-500">
							{selectedUser.firstName} {selectedUser.lastName} hasn't booked accommodation through our system yet.
						</p>
					</div>
				{/if}
			</div>
		...
		{:else}
			...
			<div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
				{#each filteredAccommodations as accommodation}
					<div class="overflow-hidden rounded-lg border border-irish-stone bg-white shadow-md transition-all hover:shadow-lg hover:border-irish-green">
						<!-- Accommodation Image -->
						...
						<div class="p-6">
							...
							<div class="flex gap-3">
								<a
									...
									class="flex-1 rounded-lg px-4 py-2 text-center text-white bg-irish-green transition-colors hover:bg-irish-green-dark"
								>
									View Details
								</a>
								{#if accommodation.address}
